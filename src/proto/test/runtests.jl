...
@testset "OpenTelemetryProto.jl" begin
    ...
    metrics_req = OpentelemetryClients.opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest(
        resource_metrics = [
    ...
    log_req = OpentelemetryClients.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest(
        resource_logs = [
                    ...
                    OpentelemetryClients.opentelemetry.proto.logs.v1.InstrumentationLibraryLogs(
                        ...
                        log_records = [
                            OpentelemetryClients.opentelemetry.proto.logs.v1.LogRecord(
                                ...
                                severity_text = "ERROR",
                                body = OpentelemetryClients.opentelemetry.proto.common.v1.AnyValue(string_value = "Oh no!"),
                                attributes = [],
                                dropped_attributes_count = 0,
                                trace_id = reinterpret(UInt8, rand(UInt128, 1)),
                                span_id = reinterpret(UInt8, rand(UInt64, 1)),
