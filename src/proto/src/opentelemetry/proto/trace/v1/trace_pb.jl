...
# original file: opentelemetry/proto/trace/v1/trace.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Span.Event"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Span.Link"}, _endpos::Int=0, _group::Bool=false)
    trace_id = UInt8[]
    span_id = UInt8[]
    trace_state = ""
    attributes = PB.BufferedVector{opentelemetry.proto.common.v1.KeyValue}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Status}, _endpos::Int=0, _group::Bool=false)
    message = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Span}, _endpos::Int=0, _group::Bool=false)
    trace_id = UInt8[]
    span_id = UInt8[]
    trace_state = ""
    parent_span_id = UInt8[]
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ScopeSpans}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ResourceSpans}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TracesData}, _endpos::Int=0, _group::Bool=false)
