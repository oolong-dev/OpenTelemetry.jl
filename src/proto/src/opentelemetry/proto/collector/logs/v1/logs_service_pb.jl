...
# original file: opentelemetry/proto/collector/logs/v1/logs_service.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportLogsServiceRequest}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportLogsPartialSuccess}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportLogsServiceResponse}, _endpos::Int=0, _group::Bool=false)
