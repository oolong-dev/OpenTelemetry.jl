...
# original file: opentelemetry/proto/collector/trace/v1/trace_service.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportTracePartialSuccess}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportTraceServiceRequest}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExportTraceServiceResponse}, _endpos::Int=0, _group::Bool=false)
