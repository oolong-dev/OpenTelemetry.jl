...
"""
OTEL_EXPORTER_PROMETHEUS_HOST() = get(ENV, "OTEL_EXPORTER_PROMETHEUS_HOST", "127.0.0.1")
...
OTEL_EXPORTER_OTLP_PROTOCOL() = get(ENV, "OTEL_EXPORTER_OTLP_PROTOCOL", "http/protobuf")
OTEL_EXPORTER_OTLP_LOGS_PROTOCOL() =
    get(ENV, "OTEL_EXPORTER_OTLP_LOGS_PROTOCOL", OTEL_EXPORTER_OTLP_PROTOCOL())
OTEL_EXPORTER_OTLP_TRACES_PROTOCOL() =
    get(ENV, "OTEL_EXPORTER_OTLP_TRACES_PROTOCOL", OTEL_EXPORTER_OTLP_PROTOCOL())
OTEL_EXPORTER_OTLP_METRICS_PROTOCOL() =
    get(ENV, "OTEL_EXPORTER_OTLP_METRICS_PROTOCOL", OTEL_EXPORTER_OTLP_PROTOCOL())

# TIMEOUT
export OTEL_EXPORTER_OTLP_TIMEOUT,
    OTEL_EXPORTER_OTLP_LOGS_TIMEOUT,
    OTEL_EXPORTER_OTLP_TRACES_TIMEOUT,
    OTEL_EXPORTER_OTLP_METRICS_TIMEOUT

OTEL_EXPORTER_OTLP_TIMEOUT() = parse(Int, get(ENV, "OTEL_EXPORTER_OTLP_TIMEOUT", "10"))
OTEL_EXPORTER_OTLP_LOGS_TIMEOUT() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_LOGS_TIMEOUT")
        parse(Int, ENV["OTEL_EXPORTER_OTLP_LOGS_TIMEOUT"])
    else
        OTEL_EXPORTER_OTLP_TIMEOUT()
    end
OTEL_EXPORTER_OTLP_TRACES_TIMEOUT() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_TRACES_TIMEOUT")
        parse(Int, ENV["OTEL_EXPORTER_OTLP_TRACES_TIMEOUT"])
    else
        OTEL_EXPORTER_OTLP_TIMEOUT()
    end
OTEL_EXPORTER_OTLP_METRICS_TIMEOUT() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_METRICS_TIMEOUT")
        parse(Int, ENV["OTEL_EXPORTER_OTLP_METRICS_TIMEOUT"])
    else
        OTEL_EXPORTER_OTLP_TIMEOUT()
    end
...
OTEL_EXPORTER_OTLP_ENDPOINT() =
    get(ENV, "OTEL_EXPORTER_OTLP_ENDPOINT", if OTEL_EXPORTER_OTLP_PROTOCOL() == "grpc"
        "http://localhost:4317"
    else
        "http://localhost:4318"
    end)
...
OTEL_EXPORTER_OTLP_LOGS_ENDPOINT() =
    get(ENV, "OTEL_EXPORTER_OTLP_LOGS_ENDPOINT", OTEL_EXPORTER_OTLP_ENDPOINT())

OTEL_EXPORTER_OTLP_TRACES_ENDPOINT() =
    get(ENV, "OTEL_EXPORTER_OTLP_TRACES_ENDPOINT", OTEL_EXPORTER_OTLP_ENDPOINT())

OTEL_EXPORTER_OTLP_METRICS_ENDPOINT() =
    get(ENV, "OTEL_EXPORTER_OTLP_METRICS_ENDPOINT", OTEL_EXPORTER_OTLP_ENDPOINT())
...
extract_headers(s::String) =
    Pair{String,String}[string(k) => string(v) for (k, v) in pairs(extract_attrs(s))]

OTEL_EXPORTER_OTLP_HEADERS() = get(ENV, "OTEL_EXPORTER_OTLP_HEADERS", "") |> extract_headers
OTEL_EXPORTER_OTLP_LOGS_HEADERS() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_LOGS_HEADERS")
        extract_headers(ENV["OTEL_EXPORTER_OTLP_LOGS_HEADERS"])
    else
        OTEL_EXPORTER_OTLP_HEADERS()
    end
OTEL_EXPORTER_OTLP_TRACES_HEADERS() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_TRACES_HEADERS")
        extract_headers(ENV["OTEL_EXPORTER_OTLP_TRACES_HEADERS"])
    else
        OTEL_EXPORTER_OTLP_HEADERS()
    end
OTEL_EXPORTER_OTLP_METRICS_HEADERS() =
    if haskey(ENV, "OTEL_EXPORTER_OTLP_METRICS_HEADERS")
        extract_headers(ENV["OTEL_EXPORTER_OTLP_METRICS_HEADERS"])
    else
        OTEL_EXPORTER_OTLP_HEADERS()
    end